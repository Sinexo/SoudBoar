...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val buttonSound1 = findViewById<ImageButton>(R.id.button1)
        val buttonSound2 = findViewById<ImageButton>(R.id.button2)
        ...
        addSoundButton = findViewById<ImageButton>(R.id.addSoundButton) // Correctly cast to ImageButton
